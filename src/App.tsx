...
export default function App() {
  ...
  if (isInitializing) {
    return (
      <div className="flex min-h-screen flex-col">
        <div className="flex flex-1 flex-col items-center justify-center bg-[#030712] p-6 font-sans text-slate-100 selection:bg-indigo-500/30">
  ...
  const legalPage = renderLegalRoute(pathname, Boolean(session));
  if (legalPage && isLegalRoute(pathname)) {
    return (
      <div className="flex min-h-screen flex-col">
        {legalPage}
        <Footer />
  ...
  return (
    <div className="flex min-h-screen flex-col">
      <div
        className="flex flex-1 items-center justify-center bg-[#030712] p-4 font-sans text-slate-100 selection:bg-indigo-500/30"
        style={{
          backgroundImage:
